...
var Infinite = React.createClass({
  ...
  getChildren: function getChildren(start, end) {
    // optional start/end
    return this.getChildrenFromProps(this.props, start, end);
  },
  getChildrenFromProps: function getChildrenFromProps(props, start, end) {
    if (props.getChildren) return props.getChildren(start, end);
  ...
  recomputeInternalStateFromProps: function recomputeInternalStateFromProps(props) {
    ...
    var create = props.createComputer ? props.createComputer : infiniteHelpers.createInfiniteComputer;
    newState.infiniteComputer = create(computedProps.elementHeight, computedProps.children, computedProps.displayBottomUpwards);
